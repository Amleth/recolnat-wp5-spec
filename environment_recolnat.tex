...
\starttypescript[Main]
  ...
  \definetypeface[Main][tt][mono][gill][default][rscale=0.85]
\stoptypescript
...
\define\warning{
  ...
  \startnarrower
    \startframedtext[width=.69\makeupwidth,location=middle]
      ...
      \item Ce document est amené à évoluer, ses modifications peuvent être suivies sur son \goto{dépôt Github.}[url(https://github.com/Amleth/recolnat-wp5-spec)]
      \stopitemize
    \stopframedtext
  \stopnarrower
  \blank[3cm]
