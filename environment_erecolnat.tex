...
\define\warning{
  ...
  \startnarrower
    \startframedtext[width=.69\makeupwidth,location=middle]
      \startitemize
      \item Ce document faisant usage des liens hypertextes PDF, pour un confort de lecture maximal, assurez-vous que votre lecteur de PDF supporte cette fonction.
