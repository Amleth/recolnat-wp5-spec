\startenvironment environ_erecolnat
...
\starttypescript[mono][gill]
  \definefontsynonym[Mono][name:gillsansstd]
  \definefontsynonym[MonoBold][name:gillsansstdbold]
\stoptypescript
...
\starttypescript[Main]
  ...
  \definetypeface[Main][tt][mono][gill]
\stoptypescript
...
\define\warning{
  ...
  \startnarrower
    \startframedtext[width=.69\makeupwidth,location=middle]
      \startitemize
      \item Ce document faisant grand usage des liens hypertextes PDF, pour un confort de lecture maximal, assurez-vous que votre lecteur de PDF supporte cette fonction.
      \item Ce document est amené à évoluer, ses modifications peuvent être suivies sur son \goto{dépôt Github.}[url(https://github.com/Amleth/erecolnat-wp5-spec)]
      \stopitemize
    \stopframedtext
  \stopnarrower
  \blank[3cm]
