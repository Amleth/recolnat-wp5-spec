...
L'API du service de Tags sera bientôt disponible sur le \goto{dépôt Github des APIs ReColNat+}[url(https://github.com/Amleth/erecolnat-wp5-apis)]\footnote{https://github.com/Amleth/erecolnat-wp5-apis}.